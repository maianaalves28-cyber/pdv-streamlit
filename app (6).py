...
def processar_codigo_barras(codigo_barras, peso_manual, produtos_data):
    ...
    try:
        ...
        if len(codigo_barras) == 13 and codigo_barras.startswith('2'):
            ...
            # CORREÇÃO FINAL baseada no exemplo 2019200005980 (peso 0.598 kg):
            # Os 5 dígitos após o código do produto (índices 5 a 10) representam o peso em gramas.
            # No exemplo, '00598' deve ser 598 gramas, que é 0.598 kg.
            # A extração estava correta (índices 5:10), mas a interpretação anterior estava confusa.
            # Agora, confirmamos que os 5 dígitos representam gramas e dividimos por 1000 para obter kg.
