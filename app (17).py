...
def processar_codigo_barras(codigo_barras, peso_manual, produtos_data):
    ...
    try:
        ...
        # PP PP: Código do produto (4 dígitos) - Posições 2 a 5 (índices 1 a 4)
        ...
        if len(codigo_barras) == 13 and codigo_barras.startswith('2'):
            ...
            # Peso em Gramas: 6 dígitos, posições 7 a 12 (índices 6 a 11) - Ajustado para 6 dígitos
            peso_raw = codigo_barras[6:12] # Peso em gramas (6 dígitos)

            # Converte para kg dividindo por 1000.0 (leitura em gramas)
            # Mantendo a divisão por 1000.0, assumindo que os 6 dígitos representam gramas com 3 casas decimais implícitas.
